...
def update_drop_down(name, **kwargs):
    ...
    if current_user.groups.filter(name='Hotel Group Administrators').exists(): 
        ...
        services = ServiceBooking.objects.filter(service__service_type='co_share').filter(service__hotel_group_id=hotel_group_id)\
        ...
        services = ServiceBooking.objects.filter(service__service_type='co_share').filter(service__hotel_id=hotel_id)\
                    .values('service__hotel_group__hotel_group_name','service__hotel_group_id')
    else:
        services = ServiceBooking.objects.filter(service__service_type='co_share')\
                    .values('service__hotel_group__hotel_group_name','service__hotel_group_id') 
